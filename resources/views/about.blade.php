								...
								<div class="block-widget-wrap">
									<div class="intro-wrap">
										...
										<h2 class="intro-title">
									 		Timeless Silver, Crafted for You
										</h2>
										<div class="intro-text">
								 			Welcome to Swarnsilva, where tradition meets modern elegance. We are a premium silver jewelry brand based in Karol Bagh, a renowned hub of fine jewelry craftsmanship. Our brand is dedicated to crafting exquisite, high-quality, and lightweight silver pieces that blend artistry with sophistication. Each design reflects a perfect balance of tradition and contemporary elegance. 
										</div>
									</div>
								</div>
							</div>
								...
								<div class="block-widget-wrap">
									<div class="row">
										<div class="section-column left">
											<div class="intro-wrap">
												<h2 class="intro-title">Our Legacy –</h2>
												<div class="intro-item m-b-0">
													Swarnsilva is built on a rich heritage of jewelry craftsmanship, inspired by over 50 years of experience in the industry. With deep-rooted expertise passed down from our founder’s father, who has spent decades mastering the art of fine jewelry, we bring you a perfect fusion of traditional excellence and modern designs.
												</div>

												<h2 class="intro-title" style="padding-top: 50px;">Our Craftsmanship –</h2>
												<div class="intro-item m-b-0">
													Each Swarnsilva piece is meticulously designed and handcrafted by skilled artisans. We use 925 sterling silver, ensuring durability, brilliance, and lasting beauty. Our collection features a unique blend.
												</div>
											</div>
										</div>
							...
							<div class="block block-intro layout-7">
								<div class="block-widget-wrap">
									<div class="row">
										...
										<div class="section-column right">
											<div class="intro-wrap">
												<h2 class="intro-title">Visit Us in <strong>Karol Bagh</strong></h2>
												<div class="intro-item m-b-0">
											 		Experience the elegance of Swarnsilva in person at our store in Karol Bagh, where craftsmanship meets authenticity. Explore our collection and discover the beauty of silver jewelry that speaks to your soul.
											 		<br/><br/>
											 		✨ Swarnsilva – Where Every Piece Tells a Story. ✨
												</div>
											</div>
										</div>
									</div>
