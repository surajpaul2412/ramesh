    ...
    <form class="tf-section-2 form-add-product">
        <div class="wg-box">
            <fieldset class="name">
                ...
                <input class="mb-10" type="text" placeholder="Enter product name" tabindex="0" aria-required="true" required="" name="text"/>
        ...
        <div class="wg-box">
            <fieldset>
                ...
                <div class="upload-image mb-16">
                    ...
                    <div class="item"><img src="/images/upload/upload-2.png" alt=""/></div>
                    <div class="item up-load"><label class="uploadfile" for="myFile"><span class="icon"><i class="icon-upload-cloud"></i></span><span class="text-tiny">Drop your images here or select <span class="tf-color">click to browse</span></span><input type="file" id="myFile" name="filename"/></label></div>
                </div>
            ...
            <div class="cols gap22">
                ...
                <fieldset class="name">
                    ...
                    <div class="select"><input type="date" name="date"/></div>
                </fieldset>
            </div>
            <div class="cols gap10"><button class="tf-button w-full" type="submit">Add product</button><button class="tf-button style-1 w-full" type="submit">Save product</button><a class="tf-button style-2 w-full" href="#">Schedule</a></div>
        </div>
    </form>
</div>
@endsection
