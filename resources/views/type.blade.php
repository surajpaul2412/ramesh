			...
			<div id="title" class="page-title">
				<div class="section-container">
					...
					<div class="breadcrumbs">
						<a href="{{route('welcome')}}">Home</a><span class="delimiter"></span><a href="{{ route('shop') }}">Shop</a><span class="delimiter"></span>{{ ucfirst($type->name) }}
					</div>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-xl-3 col-lg-3 col-md-12 col-12 sidebar left-sidebar md-b-50 p-t-10">
								...
								<div class="block block-product-cats">
									<div class="block-title"><h2>Other Types</h2></div>
									<div class="block-content">
										<div class="product-cats-list">
											<ul>
												@foreach(types() as $type)
												<li class="current">
													<a href="{{route('type', $type->slug)}}">{{$type->name}} <span class="count">{{$type->products->count()}}</span></a>
												</li>
												@endforeach
											</ul>
										</div>
